...
class PesananController extends Controller
{
    public function index(Request $request) {
        ...
        if(session()->has('email_pengguna')) {
            ...
            ->where('pesanan.id_pengguna', session('id_pengguna'))->get();

            $invoice = DB::table('tbl_invoice as invoice');

            return view('pengguna.pesanan.pesanan', ['data_pesanan' => $data, 'invoice' => $invoice]);
